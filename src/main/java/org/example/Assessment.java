...
public class Assessment {
    ...
    public Assessment(){
        assessmentM = new String[]{
                ...
                " was alert, oriented, with a calm affect and no new or significant changes in cognition, perception, thoughts, behavior, insight or judgment. They had appropriate behavior and were able to convey thoughts and feelings and participate as they felt comfortable.",
